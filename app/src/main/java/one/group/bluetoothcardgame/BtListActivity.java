        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action)) {
                ...
                if (state == BluetoothDevice.BOND_BONDED && prevState == BluetoothDevice.BOND_BONDING) {
                    showToast("Paired");
                    BluetoothDevice connected = (BluetoothDevice)intent.getParcelableExtra(BluetoothDevice.EXTRA_DEVICE);
                    Intent intent1 = new Intent(BtListActivity.this, BtMessageActivity.class);
                    intent1.putExtra("btdevice", connected);
